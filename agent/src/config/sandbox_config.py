...
class SandboxConfig(BaseModel):
    ...
    Common options:
        ...
        enabled: Whether sandbox is enabled (default: true). When disabled,
                 file/bash tools are removed and SandboxMiddleware is skipped.
    ...
    AioSandboxProvider specific options:
        ...
        container_prefix: Prefix for container names (default: nous-ai-sandbox)
    ...
    enabled: bool = Field(
        default=True,
        description="Whether sandbox is enabled. When disabled, file/bash tools are removed and SandboxMiddleware is skipped.",
    )
    use: str = Field(
        ...,
