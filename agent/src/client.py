...
class DeerFlowClient:
    ...
    def get_memory(self) -> dict:
        ...
        In multi-user mode, memory is per-user and stored in PostgreSQL.
        This method returns an empty structure; use SessionManager for
        per-user reads.
        """
        return {
            "version": "1.0",
    ...
    def reload_memory(self) -> dict:
        ...
        In multi-user mode, memory is always read from PostgreSQL on
        demand.  This method returns an empty structure for API compat.
        """
