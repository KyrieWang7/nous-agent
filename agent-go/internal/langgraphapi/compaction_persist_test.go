...
func TestCompactionTurnPersistsTheCompactedTranscript(t *testing.T) {
	...
	resp, err := http.Post(ts.URL+"/threads/thread-c/runs/stream", "application/json",
...
func TestCompactionTurnWithoutTranscriptDoesNotOverwriteHistory(t *testing.T) {
	...
	resp, err := http.Post(ts.URL+"/threads/thread-missing-transcript/runs/stream", "application/json",
