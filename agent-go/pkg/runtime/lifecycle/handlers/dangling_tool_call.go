...
// BeforeModel 实现 lifecycle.BeforeModel。
func (DanglingToolCall) BeforeModel(_ context.Context, st *lifecycle.State) error {
	if st.History == nil {
		return nil
	}
