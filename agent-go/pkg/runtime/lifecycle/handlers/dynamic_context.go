...
type DynamicContext struct {
	Text func(*lifecycle.State) string
}

func NewDynamicContext(fn func(*lifecycle.State) string) *DynamicContext {
	return &DynamicContext{Text: fn}
}
func (DynamicContext) Name() string { return NameDynamicContext }
func (d *DynamicContext) BeforeModel(_ context.Context, st *lifecycle.State) error {
