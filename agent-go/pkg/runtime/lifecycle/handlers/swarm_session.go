...
func (s *SwarmSession) BeforeAgent(ctx context.Context, st *lifecycle.State) error {
...
message for another teammate must use send_message: use to="lead" for the
...
func setSwarmSessionValues(st *lifecycle.State, runValues map[string]any, teamID, teamName, agentName string) {
