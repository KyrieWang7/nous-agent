...
// NameToolOutputBudget 是工具输出预算中间件的名字。
...
// NewToolOutputBudget 返回工具输出预算中间件。
...
// 不该让已经跑成功的工具白跑。
func (b *ToolOutputBudget) Grade() middleware.Grade { return middleware.GradeListener }

// AfterTool 实现 middleware.AfterTool。
func (b *ToolOutputBudget) AfterTool(ctx context.Context, st *middleware.State) error {
