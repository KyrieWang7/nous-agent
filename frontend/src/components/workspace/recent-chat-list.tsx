        ...
        <SidebarGroup>
          <div className="flex items-center justify-between px-2 mb-1">
            <CollapsibleTrigger asChild>
              <SidebarGroupLabel className="group/label flex h-8 cursor-pointer items-center px-0 pr-2 text-[13px] font-semibold text-sidebar-foreground/54 transition-colors hover:text-sidebar-foreground/74">
                <ChevronRight className="mr-1 size-3 transition-transform group-data-[state=open]/collapsible:rotate-90" />
                    ...
                    return (
                      ...
                      >
                        <SidebarMenuButton
                          isActive={isActive}
                          asChild
                          className="h-8 text-[14px] font-medium hover:bg-sidebar-accent"
                        >
                          <div>
                            <Link
                            ...
                            {env.NEXT_PUBLIC_STATIC_WEBSITE_ONLY !== "true" && (
                              <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                  <SidebarMenuAction
                                    showOnHover
                                    className="bg-white/80 hover:bg-white h-6 w-6 border border-sidebar-border/80 shadow-sm backdrop-blur mr-1"
                                  >
                                ...
                                >
                                  ...
                                  >
                                    <Share2 className="text-muted-foreground size-4 mr-2" />
