...
export const MessageContent = ({
  ...
  <div
    className={cn(
      ...
      "group-[.is-user]:bg-primary/90 group-[.is-user]:text-primary-foreground group-[.is-user]:ml-auto group-[.is-user]:rounded-2xl group-[.is-user]:rounded-br-sm group-[.is-user]:px-4 group-[.is-user]:py-3 group-[.is-user]:shadow-sm",
